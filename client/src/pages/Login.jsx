...
const Login = ({ setIsAutenticated }) => {
   ...
   return (
      ...
      ${toggle
            ? 'before:translate-y-[-88%] md:before:translate-x-[-60%] md:before:translate-y-[-85%] lg:before:translate-y-[-50%] lg:before:translate-x-[-100%]'
         ...
         ${toggle
            ...
            <IntroForm
               className=' text-white flex flex-col items-center gap-2 lg:gap-12'
